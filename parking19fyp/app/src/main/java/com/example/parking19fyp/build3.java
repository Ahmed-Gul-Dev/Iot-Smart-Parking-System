...
public class build3 extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.building2:
                    Intent k = new Intent(build3.this, Building2.class);
                    startActivity(k);
                    return true;
                case R.id.home:
                    Intent l = new Intent(build3.this, MainActivity.class);
                    startActivity(l);
                    return true;
                case R.id.building4:
                    Intent m = new Intent(build3.this, build4.class);
                    startActivity(m);
                    return true;
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1 = (TextView) findViewById(R.id.STATUS31);
        text2 = (TextView) findViewById(R.id.STATUS32);
        text3 = (TextView) findViewById(R.id.STATUS33);
        ...
        b1fnode = node.child("p7");
        b1snode = node.child("p8");
        b1tnode = node.child("p9");
...
//                text1.setAllCaps(true);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(build3.this, "Connection Error", Toast.LENGTH_LONG).show();
            }
        });
...
//                text1.setAllCaps(true);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(build3.this, "Data Sent", Toast.LENGTH_LONG).show();
            }
        });
