...
public class build4 extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.building2:
                    Intent k = new Intent(build4.this, Building2.class);
                    startActivity(k);
                    return true;
                case R.id.building3:
                    Intent l = new Intent(build4.this, build3.class);
                    startActivity(l);
                    return true;
                case R.id.home:
                    Intent m = new Intent(build4.this, MainActivity.class);
                    startActivity(m);
                    return true;
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1 = (TextView) findViewById(R.id.STATUS41);
        text2 = (TextView) findViewById(R.id.STATUS42);
        text3 = (TextView) findViewById(R.id.STATUS43);
        ...
        b1fnode = node.child("p10");
        b1snode = node.child("p11");
        b1tnode = node.child("p12");
...
//                text1.setAllCaps(true);
            ...
            public void onCancelled(DatabaseError error) {
                Toast.makeText(build4.this, "Connection Error", Toast.LENGTH_LONG).show();
            }
        });
...
//                text1.setAllCaps(true);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(build4.this, "Data Sent", Toast.LENGTH_LONG).show();
            }
        });
